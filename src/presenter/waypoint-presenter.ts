...
export default class WaypointPresenter {
  ...
  #handleFavoriteClick = () => {
    if (this.#waypoint) {
      this.#handleDataChange(UserAction.updateWaypoint, UpdateType.MINOR, { ...this.#waypoint, isFavorite: !this.#waypoint.isFavorite });
    }
  };
  ...
  #handleFormSubmit = (updateWaypoint: Waypoint) => {
    ...
    this.#handleDataChange(UserAction.updateWaypoint, isMinorUpdate ? UpdateType.MINOR : UpdateType.PATCH, updateWaypoint);
    this.#switchToViewMode();
  };

  #handleDeleteClick = (waypoint: Waypoint) => {
    this.#handleDataChange(UserAction.deleteWaypoint, UpdateType.MINOR, waypoint);
  };
}
